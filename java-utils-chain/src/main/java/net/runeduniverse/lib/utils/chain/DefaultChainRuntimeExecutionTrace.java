...
import net.runeduniverse.lib.utils.chain.api.ChainRuntimeExecutionTrace;
import net.runeduniverse.lib.utils.logging.log.DefaultCompoundTree;
import net.runeduniverse.lib.utils.logging.log.api.CompoundTree;

public class DefaultChainRuntimeExecutionTrace implements ChainRuntimeExecutionTrace {
	...
	public DefaultChainRuntimeExecutionTrace(DefaultChainRuntime<?> runtime, String chainLabel) {
		this.tree = new DefaultCompoundTree("CHAIN", this.chainLabel = chainLabel);
		if (runtime == null)
